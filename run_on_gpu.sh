...
export APPTAINER_IMAGE=${APPTAINER_IMAGE:-"/path/to/models"}

export MODEL_PATH=${MODEL_PATH:-"/path/to/user/Qwen3-VL-8B-Instruct"}
export DATASET_PATH=${DATASET_PATH:-"/path/to/user/dataset/wemath_difficulty.json"}
export WORKSPACE_DIR=${WORKSPACE_DIR:-"/path/to/user/new_pipeline_sft"}
...
export JUDGE_MODEL_PATH=${JUDGE_MODEL_PATH:-"/path/to/user/models/Qwen3-30B-A3B-Instruct-2507"}
...
export LLM_GENERATOR_MODEL_PATH=${LLM_GENERATOR_MODEL_PATH:-"/path/to/user/Qwen3-VL-235B-A22B-Thinking"}
...
export GEMINI_BASE_URL=${GEMINI_BASE_URL:-"https://api.example.com/v1/"}
export GEMINI_MAX_TOKENS=${GEMINI_MAX_TOKENS:-65536}
export GEMINI_MAX_OUTPUT_TOKENS=${GEMINI_MAX_OUTPUT_TOKENS:-65536}

export CORRECTED_COT_API_KEY=${CORRECTED_COT_API_KEY:-"YOUR_API_KEY_HERE"}
export CORRECTED_COT_MODEL=${CORRECTED_COT_MODEL:-"qwen3-vl-235b-a22b-thinking"}
export CORRECTED_COT_BASE_URL=${CORRECTED_COT_BASE_URL:-"https://api.example.com/v1/"}
export CORRECTED_COT_MAX_WORKERS=${CORRECTED_COT_MAX_WORKERS:-30}

export ENABLE_ERROR_ANALYSIS=${ENABLE_ERROR_ANALYSIS:-true}
export ERROR_ANALYZER_MODEL_PATH=${ERROR_ANALYZER_MODEL_PATH:-"/path/to/user/Qwen3-VL-30B-A3B-Thinking"}
