...
_image_pixel_limit = os.environ.get("PIL_MAX_IMAGE_PIXELS")
if _image_pixel_limit:
    Image.MAX_IMAGE_PIXELS = None if _image_pixel_limit.lower() == "none" else int(_image_pixel_limit)
else:
